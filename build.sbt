...
lazy val root = (project in file(".")).
  settings(
    ...
    mainClass in assembly := Some("com.rahulsinghai.AWSToolkitApp"), // To set an explicit main class
    assemblyJarName in assembly := "aws-toolkit.jar",  // Name of the jar to be generated
